...
async def holod_chai(message: types.Message):
...
def register_handlers_cholod_chai(dp: Dispatcher):
    dp.register_message_handler(holod_chai, commands=['Холодильники_и_чайники'])
