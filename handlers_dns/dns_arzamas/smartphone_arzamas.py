...
async def smart_arz(message: types.Message):
...
def register_handlers_smart_arz(dp: Dispatcher):
    dp.register_message_handler(smart_arz, commands=['Смартфоны_Арзамас'])