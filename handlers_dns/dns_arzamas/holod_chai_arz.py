...
async def holod_chai_arz(message: types.Message):
        ...
        url = f"https://www.dns-shop.ru/catalog/actions/?stock=now-today-tomorrow&category=4e2a7cdb390b7fd7-17a8c8d116404e77&action=rassrockailivygoda-tovarysoskidkoj"
        driver.get(url)
        ...
        for i in range(int(page)):
                ...
                url = f"https://www.dns-shop.ru/catalog/actions/?stock=now-today-tomorrow&category=4e2a7cdb390b7fd7-17a8c8d116404e77&action=rassrockailivygoda-tovarysoskidkoj&p={i}"
                driver.get(url)
...
def register_handlers_cholod_chai_arz(dp: Dispatcher):
    dp.register_message_handler(holod_chai_arz, commands=['Холодильники_и_чайники_Арзамас'])