...
async def different_arz(message: types.Message):
...
def register_handlers_different_arz(dp: Dispatcher):
    dp.register_message_handler(different_arz, commands=['Разное_Арзамас'])