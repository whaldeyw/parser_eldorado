...
async def tv_arz(message: types.Message):
        ...
        url = f"https://www.dns-shop.ru/catalog/actions/?stock=now-today-tomorrow&category=17a8ae4916404e77-17a8943716404e77&action=rassrockailivygoda-tovarysoskidkoj"
        driver.get(url)
        ...
        for i in range(int(page)):
                ...
                url = f"https://www.dns-shop.ru/catalog/actions/?stock=now-today-tomorrow&category=17a8ae4916404e77-17a8943716404e77&action=rassrockailivygoda-tovarysoskidkoj&p={i}"
                driver.get(url)
...
def register_handlers_tv_arz(dp: Dispatcher):
    dp.register_message_handler(tv_arz, commands=['Телевизоры_и_мониторы_Арзамас'])