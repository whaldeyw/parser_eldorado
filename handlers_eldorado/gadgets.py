...
async def gadgets(message: types.Message):
    ...
    url = f"https://www.eldorado.ru/promo/podarki-so-skidkami-gadgets/"
    driver.get(url)
...
def register_handlers_gadgets(dp: Dispatcher):
    dp.register_message_handler(gadgets, commands=['Гаджеты'])