...
async def smartphone(message: types.Message):
    ...
    url = f"https://www.eldorado.ru/promo/podarki-so-skidkami-smartphones/"
    driver.get(url)
...
def register_handlers_smartphone(dp: Dispatcher):
    dp.register_message_handler(smartphone, commands=['Смартфоны'])