...
async def beauty(message: types.Message):
    ...
    url = f"https://www.eldorado.ru/promo/podarki-so-skidkami-beauty/"
    driver.get(url)
...
def register_handlers_beauty(dp: Dispatcher):
    dp.register_message_handler(beauty, commands=['Красота_и_Здоровье'])