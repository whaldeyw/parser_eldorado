...
# @dp.message_handler(commands=['Техника ждя дома'])
async def mes_hom(message: types.Message):
...
def register_handlers_home(dp: Dispatcher):
    dp.register_message_handler(mes_hom, commands=['Техника_для_дома'])