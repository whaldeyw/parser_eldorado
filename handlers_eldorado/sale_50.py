...
async def sale_(message: types.Message):
    ...
    url = f"https://www.eldorado.ru/promo/podarki-so-skidkami/?from=hub"
    driver.get(url)
...
def register_handlers_sale_50(dp: Dispatcher):
    dp.register_message_handler(sale_, commands=['Скидки_до_50%'])