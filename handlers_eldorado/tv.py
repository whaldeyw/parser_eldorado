...
async def tv(message: types.Message):
    ...
    url = f"https://www.eldorado.ru/promo/podarki-so-skidkami-tv/"
    driver.get(url)
...
def register_handlers_tv(dp: Dispatcher):
    dp.register_message_handler(tv, commands=['Телевизоры,Аудиотехника'])