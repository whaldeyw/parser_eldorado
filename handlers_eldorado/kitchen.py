...
async def kitchen(message: types.Message):
    ...
    url = f"https://www.eldorado.ru/promo/podarki-so-skidkami-kitchen/"
    driver.get(url)
...
def register_handlers_kitchen(dp: Dispatcher):
    dp.register_message_handler(kitchen, commands=['Кухня'])